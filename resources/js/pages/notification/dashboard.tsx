            ...
            {auth && auth.user.role === 'user' ? (
                ...
                <div className="space-y-10 p-4">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        <StatCard title="Total Karyawan" value={employees.length.toString()} />
                        <StatCard title="Total Divisi" value={divisions.length.toString()} />
                        <StatCard title="Jumlah Penilaian KPI (Dummy)" value="123" />
                    </div>

                    {/* Placeholder Grafik KPI */}
                    <Card>
                        <CardHeader>
                            <CardTitle>Grafik Performa KPI Bulanan (Dummy)</CardTitle>
                        </CardHeader>
                    ...
                    {/* Tabel Penilaian KPI Terbaru */}
                    <Card>
                        <CardHeader>
                            <CardTitle>Daftar Penilaian KPI Terbaru (Dummy)</CardTitle>
                        </CardHeader>
                        <CardContent>
